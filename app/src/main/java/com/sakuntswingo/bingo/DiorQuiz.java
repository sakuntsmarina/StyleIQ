...
public class DiorQuiz extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (backBtn == null) {
            Log.e("DiorQuiz", "Back button not found. Check if R.id.back_btn exists in activity_dior_quiz.xml");
            ...
            backBtn.setOnClickListener(v -> {
                try {
                    ...
                    Log.e("DiorQuiz", "Error navigating to ProfileActivity: " + e.getMessage());
        ...
        db.collection("quizzes")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(DiorQuiz.this, "Не удалось загрузить вопросы", Toast.LENGTH_SHORT).show();
                    }
                });
    }
